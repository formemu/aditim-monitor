...
class ApiProduct(ApiClient):
    ...
    def update_product(self, product_id, product_data):
        ...
        return self._request("PATCH", f"/api/product/{product_id}", json=product_data)
    ...
    def delete_product_component(self, product_id):
        """Удаление компонентов продукта"""
        self._request("DELETE", f"/api/product/{product_id}/component")
